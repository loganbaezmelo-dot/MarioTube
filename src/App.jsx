      ...
      <div className="max-w-6xl mx-auto mt-20 relative z-20">
        <div className="text-center mb-16 space-y-4">
          ...
          <div className="inline-block border-4 border-white p-4 bg-black/80 max-w-2xl relative">
            ...
            {/* Subscribe Button (Top Right of Card) */}
            ...
            {/* Status Indicator */}
            {!isOwnChannel && (
               <div className={`mt-4 inline-block px-3 py-1 text-[10px] font-bold pixel-font ${isSubscribed ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-400'}`}>
