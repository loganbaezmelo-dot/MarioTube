...
// Initialize Firebase directly (No try-catch, so we see errors in console if they happen)
...
const VideoCard = ({ video, user, onUserClick }) => {
  ...
  // Like Logic (Wiped)
  // If likedBy is missing, default to empty array (effectively resetting old likes)
  ...
  const handleLike = async (e) => {
    ...
    try {
      ...
      // If doc is old/malformed, create the field
      try {
        const docRef = doc(db, VIDEO_COLLECTION, video.id);
